...
import { ConfigResponse } from 'src/app/app.component';
...
@Component({
  selector: 'app-bireport1',
  templateUrl: './bireport1.component.html',
  styleUrls: ['./bireport1.component.css']
})
export class BIReport1Component {
  ...
  async embedReport(): Promise<void> {
    ...
    //  reportConfigResponse = { Id: '', EmbedUrl: '', EmbedToken: { Token: '' } };
